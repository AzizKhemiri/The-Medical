...
<body>
    ...
    <div class="container my-5">
        <h2 style="text-align: center; margin:50px">Liste of Ordonnance</h2>

        <a class="btn btn-info" href="../mycrud(ordon)/create.php" role="button">New Ordonnance</a>
            ...
            <?php
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>$row[name]</td>
                        <td>$row[cin]</td>
                        <td>$row[medicamment]</td>
                        <td>$row[created_at]</td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='../mycrud(ordon)/edit.php?id=$row[id]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='../mycrud(ordon)/delete.php?id=$row[id]'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
