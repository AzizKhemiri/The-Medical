...
<body>
    ...
    <div class="container">
        <h2 style="text-align: center; margin:50px ">New Pos</h2>
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="user_type" placeholder="secretaire | medecin | admin" value="<?php echo $user_type; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="../mycrud(admin)/index.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
